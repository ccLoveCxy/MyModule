...
import com.imes.base.rubik.views.canvas.ClickInfoCanvas;
import com.imes.base.rubik.views.canvas.GridCanvas;
import com.imes.base.rubik.views.canvas.RelativeCanvas;
import com.imes.base.rubik.views.canvas.SelectCanvas;
...
public class OperableView extends ElementHoldView {
    ...
    private final Paint defPaint = new Paint(Paint.ANTI_ALIAS_FLAG) {{
        ...
        setStrokeWidth(ViewUtils.dip2px(2));
