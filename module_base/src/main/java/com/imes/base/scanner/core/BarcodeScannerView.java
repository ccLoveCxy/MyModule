...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    public BarcodeScannerView(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            mBorderColor = a.getColor(R.styleable.BarcodeScannerView_zxingBorderColor, mBorderColor);
            mMaskColor = a.getColor(R.styleable.BarcodeScannerView_maskColor, mMaskColor);
            mBorderWidth = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_zxingBorderWidth, mBorderWidth);
            mBorderLength = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_zxingBorderLength, mBorderLength);
            ...
            mBorderAlpha = a.getFloat(R.styleable.BarcodeScannerView_zxingBorderAlpha, mBorderAlpha);
